...
MDL geometry now preserves UVs and source bone indices and can decode the first embedded MDL texture to RGBA for the iOS Metal model pipeline. Host CMake/CTest verification passes all 7 tests.


## v0.7.0
First-person viewmodel pipeline: active weapon MDL mapping, camera-relative placement, movement bob, sway, recoil contribution, and Metal presentation.


## v0.9.0
In-game HUD overlay connected to the runtime.

## v1.5.0
NPC navigation integration: fixed arbitrary-order directed graph links, added route/waypoint steering,
and combined AI + navigation controller with regression coverage.
