...
float engine_game_health(void);
float engine_game_armor(void);
int  engine_game_weapon_id(void);
int  engine_game_weapon_clip(void);
int  engine_game_weapon_reserve(void);
unsigned int engine_game_monster_count(void);
unsigned int engine_game_monsters_alive(void);
unsigned int engine_game_shots_fired(void);
unsigned int engine_game_shots_hit(void);
unsigned int engine_game_monsters_killed(void);
unsigned int engine_game_pickup_count(void);
const char *engine_game_weapon_name(void);
float engine_game_damage_flash(void);
const char *engine_game_hud_message(void);
...
int engine_game_last_event_type(void);
int engine_game_last_event_weapon(void);
unsigned int engine_game_last_event_target(void);
float engine_game_last_event_damage(void);
void engine_game_clear_last_event(void);
...
int  engine_mdl_mesh_texture_width(void);
int  engine_mdl_mesh_texture_height(void);
...
int  engine_mdl_animation_sequence_count(void);
...
void engine_mdl_animation_stop(void);
void engine_mdl_animation_tick(float dt);
int  engine_mdl_animation_sequence(void);
float engine_mdl_animation_frame(void);
