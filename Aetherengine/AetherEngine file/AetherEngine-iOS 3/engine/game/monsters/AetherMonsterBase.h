...
typedef struct aether_monster { u32 id; char classname[64]; aether_vec3_t position,velocity; f32 health,max_health,speed,attack_range,attack_cooldown; f32 perception_range; f32 attack_damage; f32 attack_windup; bool friendly; aether_monster_state_t state; bool alive; } aether_monster_t;
